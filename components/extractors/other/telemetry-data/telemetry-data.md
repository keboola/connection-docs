...
This table shows data about the parameters of events in the [data apps](/components/data-apps/).

| **Column** | **Description** | **Example** | 
|---|---|---|
| `kbc_apps_event_id` (PK) | Unique Keboola apps event identifier | `7103338092_kbc-us-east-1` |
| `kbc_project_id` | Foreign key to the Keboola project | `7880_kbc-us-east-1` |
| `event_created_at` | Datetime when the event was created | `2023-06-14 00:13:23` |
| `event` | App event that occurred | `ext.keboola.data-apps.` |
