...
2. **Organization mode** --- extracts data from all projects of your organization. The data is extracted to a single target project. This must be set up by Keboola: Configure the extractor and contact your Keboola Customer Success Manager or our support. Provide the ID of the project containing the extractor configuration.
