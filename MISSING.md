...
| App clip | `app/index.mdx` has no clip; record the draft preview of "Staffing Outlook Grid" in project 264 (the builder's Preview pane needs no password), pointer on a red cell and the caption (phase 2). | `public/getting-started/app/` |
