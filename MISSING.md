...
| ~~Hero clip for the hub~~ | Done 2026-09-14 as `outlook-tour.mp4` (three acts, poster = the question); replaced 2026-09-23 by `hub-demo.mp4`, re-cut bright on 2026-09-25 after Nikita found it dark (24.3 s, 671 KB, luma 223; five beats: two Kai answers, the app prompt, the Apps list, the grid with the red cells outlined, then a closing line), poster = the grid with the outline and its caption. Two of Jordan's 21 Aug clip decisions changed with it, VERIFY(Jordan) in DECISIONS.md. | — |
