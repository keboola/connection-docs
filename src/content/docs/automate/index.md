...
The set of [Keboola APIs](https://developers.keboola.com/overview/api/) provides full automation of the data warehouse cycle. 
...
You can learn about how to set up our Orchestrator on [Automating Pipelines tutorial](/tutorial/automate/).
