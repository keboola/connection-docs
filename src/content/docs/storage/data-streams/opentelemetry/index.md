...
- **Import conditions** — the same configurable thresholds (time interval, data size, record count) as HTTP data streams. [Learn more](/storage/data-streams/#import-conditions)
...
- [Data Streams Documentation](/storage/data-streams/)
