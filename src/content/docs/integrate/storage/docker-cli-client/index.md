...
or when using other then [default US region](https://developers.keboola.com/overview/api/#regions-and-endpoints), you need to provide the Storage API address:
