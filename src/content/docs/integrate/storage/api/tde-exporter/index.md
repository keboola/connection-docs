...
Users can [run a TDE exporter job](https://developers.keboola.com/integrate/jobs/) as any other Keboola component or register it
...
The TDE Exporter is a Keboola [component](https://developers.keboola.com/extend/component/) supporting both
...
Then [create a job](https://developers.keboola.com/integrate/jobs/) with the specified configuration:
...
to the [general configuration format](https://developers.keboola.com/extend/common-interface/config-file/). The specific part
