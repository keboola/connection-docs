...
Many [Keboola components](/components/) use the Encryption API to encrypt sensitive values
...
![Screenshot - Configuration editor - before](/extend/encryption/encryption-1.png)

After saving, the configuration appears as follows:

![Screenshot - Configuration editor - after](/extend/encryption/encryption-2.png)
