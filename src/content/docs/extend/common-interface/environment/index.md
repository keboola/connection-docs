...
The following environment variables are injected into the container:
 ...
 - `KBC_PROJECTID`: The ID of the project in Keboola within a [Keboola stack](https://developers.keboola.com/overview/api/#regions-and-endpoints).
 - `KBC_STACKID`: The ID of the [Keboola stack](https://developers.keboola.com/overview/api/#regions-and-endpoints).
 ...
 - `KBC_STAGING_FILE_PROVIDER`: Either `aws` or `azure`, depending on the type of [stack](https://developers.keboola.com/overview/api/#regions-and-endpoints) the container is running. This value refers to the file storage used during [file import/export operations](https://developers.keboola.com/integrate/storage/api/import-export/).
