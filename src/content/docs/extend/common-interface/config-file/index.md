...
data, use [encryption](/extend/common-interface/encryption/). This section is not available in Transformations.
...
#### Encryption
Both *Image Parameters* and *Stack Parameters* support [encrypted values](/extend/common-interface/encryption/). In practice, however,
...
[Encryption](/extend/common-interface/encryption/#encrypting-data-with-api) is applied to the state the same way it is applied to
