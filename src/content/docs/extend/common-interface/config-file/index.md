...
data, use [encryption](https://developers.keboola.com/overview/encryption/). This section is not available in Transformations.
...
provide different values for different [Keboola Stacks](https://developers.keboola.com/overview/api/#regions-and-endpoints). Values in
*Stack Parameters* are merged with those in *Image Parameters* with *Stack Parameters* having a higher priority.
*Stack Parameters* are indexed with [Storage URL](https://developers.keboola.com/overview/api/#regions-and-endpoints) or the given region.
...
#### Encryption
Both *Image Parameters* and *Stack Parameters* support [encrypted values](https://developers.keboola.com/overview/encryption/). In practice, however,
...
[Encryption](https://developers.keboola.com/overview/encryption/#encrypting-data-with-api) is applied to the state the same way it is applied to
