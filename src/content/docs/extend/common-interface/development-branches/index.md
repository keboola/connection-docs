...
Configuration [states](https://developers.keboola.com/integrate/storage/api/configurations/#state) are stored separately for each development branch and are not merged back to the main branch upon merging of the branch itself.
