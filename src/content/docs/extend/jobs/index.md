...
- The Queue host of your [stack](/overview/api/#stacks-and-endpoints): `queue.keboola.com` on US AWS,
...
![Token settings dialog with access limited to a single component](/extend/jobs/token-settings.png)
...
Use the queue endpoint of your [stack](/overview/api/#stacks-and-endpoints); a wrong endpoint or
