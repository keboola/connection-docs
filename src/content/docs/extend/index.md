...
:::note[Mostly for developers]
This section is about building and extending Keboola with your own code — creating
components, working with the common interface, and publishing them. If you don't write
code, you can safely skip it. Or hand it to your AI agent: point it here and let it do
