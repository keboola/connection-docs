...
[configuration rows](https://developers.keboola.com/integrate/storage/api/configurations/#configuration-rows) and implement processing of only a single table.

Before you create any complex components, be sure to read about
[configurations](https://developers.keboola.com/integrate/storage/api/configurations/) and [processors](/extend/component/processors/)
...
If processors are used together with [configuration rows](https://developers.keboola.com/integrate/storage/api/configurations/#configuration-rows),
