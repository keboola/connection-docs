...
See the respective part of our [documentation](https://developers.keboola.com/integrate/storage/api/configurations/) for
examples of working with the [Component Configuration API](https://developers.keboola.com/integrate/storage/api/configurations/).
...
See our [configuration documentation](https://developers.keboola.com/integrate/storage/api/configurations/#modifying-a-configuration) for
...
If the configuration uses [Configuration Rows](https://developers.keboola.com/integrate/storage/api/configurations/#configuration-rows),
