...
is `https://queue.keboola.com/jobs` (in the [US Region](/overview/api/#stacks-and-endpoints)).
...
This means that an [asynchronous job](/extend/jobs/) which will prepare the archive of the data folder has been created.
