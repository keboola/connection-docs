...
Running a component means creating and executing an [asynchronous job](https://developers.keboola.com/integrate/jobs/).
...
- [encrypt values](https://developers.keboola.com/overview/encryption/).
...
- `runtime` --- [runtime settings](https://developers.keboola.com/integrate/jobs/#job-runtime-configuration) (`tag`, `backend`, `parallelism`); most notably `runtime.tag`
