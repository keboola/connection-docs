...
versions history. The following authentication configuration, combined with the parameter defined in the [`config`](/extend/generic-extractor/configuration/config/) section, does 
