...
- **Basic (Password)** — a shared password generated by Keboola. Users enter it before the app opens. Quick for internal sharing. <!-- TODO(human-review, Miro): note the password-rotation gotcha flagged in Loop A. -->
