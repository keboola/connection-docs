...
<Tabs syncKey="oidc-provider">
  ...
  <TabItem label="Microsoft Entra ID">
    ...
    **Before you start** — you need permission to register applications in your tenant; the **Application Developer** role is enough for the registration itself. Restricting who can sign in needs **Cloud Application Administrator**, **Application Administrator**, or ownership of the app's service principal.
