...
- A Keboola project. No project yet? The [Getting Started tutorial](/tutorial/#prerequisites) links a free one.
- The data the app should show, as a table in Storage. No data yet? [Upload a sample CSV](/tutorial/load/#manual-data-loading) in a few minutes, or bring in your own with a [data source connector](/components/extractors/).
