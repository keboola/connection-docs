...
description: "Keboola organization admin is a role with permissions to: - Leave and re-enter all existing projects in the organization. - View and edit billing details."
