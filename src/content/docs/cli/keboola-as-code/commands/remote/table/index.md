...
slug: 'cli/keboola-as-code/commands/remote/table'
pagefind: false
---


**Manage [tables](/storage/tables/) directly in the [project](/cli/keboola-as-code/#subsystems).**
...
| [kbc remote table preview](/cli/keboola-as-code/commands/remote/table/preview/) | Retrieve up to 1000 rows from a table. |
