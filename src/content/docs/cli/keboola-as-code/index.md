...
- Merge and rebase Keboola Branches via Git. Learn more in the [Example Use Cases](/cli/keboola-as-code/devops-use-cases/) section.
- Distribute a single project definition into multiple projects. See the [Example Use Cases](/cli/keboola-as-code/devops-use-cases/) section.
- Multi-stage (and multi-project) environment management via Git. See the [Example Use Cases](/cli/keboola-as-code/devops-use-cases/) section. 
