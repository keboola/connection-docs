...
a [Master token](/management/project/tokens/#master-tokens) to your project. It pulls all 
...
Let's say you want to download some data from Wikipedia. You can run [`kbc create`](/cli/keboola-as-code/commands/local/create/config/) 
...
a [Generic Extractor](/components/extractors/generic-extractor/) configuration. A super basic 
...
![Screenshot -- Duplicate a configuration directory](/cli/keboola-as-code/getting-started/configurations-copy-1.jpg)
...
![Screenshot -- Fixed configuration directory](/cli/keboola-as-code/getting-started/configurations-copy-2.jpg)
