...
description: "Plan a Keboola rollout: write a usage blueprint, design your project architecture and data model, follow best practices, and govern usage and costs."
redirect_from:
  - /tutorial/onboarding/
---
...
Use our [template](/overview/onboarding/usage-blueprint/) to create a blueprint that fits your company. This includes:
...
Check out our guide for creating a [multi-project setup](/overview/onboarding/architecture-guide/), which helps organize 
data tasks across several Keboola projects.

### Business Data Model Methodology
Our Business Data Model [guide](/overview/onboarding/architecture-guide/bdm-guide/)
...
Our governance [guide](/overview/onboarding/governance-guide/) teaches you to monitor usage and costs, plus enhance security.
...
Here’s a [cheat sheet](/overview/onboarding/cheat-sheet/) to help you along.
