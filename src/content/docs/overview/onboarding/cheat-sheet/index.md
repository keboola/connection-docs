...
description: 'Naming conventions, project structure, parallelization, incremental loads and development-branch habits that keep a Keboola project maintainable.'
redirect_from:
  - /tutorial/onboarding/cheat-sheet/
---
...
:::tip[Execute Individual Configurations]
...
Please be aware of the interaction between Storage and component jobs mentioned [here](/overview/onboarding/cheat-sheet/#optimize-with-parallelization). 
