...
description: 'Monitor project usage, attribute costs to teams and use cases, and keep access and security under control using Keboola telemetry.'
redirect_from:
  - /tutorial/onboarding/governance-guide/
---
...
including operating costs and adhering to security and other rules you've set in your [Keboola Platform Usage Blueprint](/overview/onboarding/usage-blueprint/).
...
4. **Configuration health metrics**: Check if created flows have schedules and notifications set up and if configurations are properly described and named according to your [**Platform Usage Blueprint**](/overview/onboarding/usage-blueprint/).
