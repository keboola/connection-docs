...
redirect_from:
  - /tutorial/branches/project-diff/
  - /getting-started/branches/project-diff/
---



You have already learned how [files](/components/branches/tutorial/files-in-branch/) and [tables](/components/branches/tutorial/tables-in-branch/) 
...
![Screenshot - Project Diff](/components/branches/tutorial/figures/show-project-diff.png)
...
![Screenshot - Project Diff](/components/branches/tutorial/figures/project-diff.png)

You should see a highlighted configuration diff. 

![Detailed diff of configuration change](/components/branches/tutorial/figures/diff-config-show-changed.png)
...
![Detailed diff of configuration change](/components/branches/tutorial/figures/diff-config-show-all.png)
...
[created in branch](/components/branches/tutorial/tables-in-branch/#extend-transformation) will not be transferred to production, 
...
Continue to the last part of our tutorial where we will show you how to [merge the branch back to production](/components/branches/tutorial/merge-to-production/).