...
programmatically using [the API](/overview/apis/). In other words, all configuration modifications are recorded.
...
the configurations are manipulated programmatically via [the API](/overview/apis/).
