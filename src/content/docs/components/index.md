...
programmatically using [the API](/overview/#apis-and-service-endpoints). In other words, all configuration modifications are recorded.
...
the configurations are manipulated programmatically via [the API](/overview/#apis-and-service-endpoints).
