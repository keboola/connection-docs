...
Due to the versatility of different APIs running in the wild, Generic Extractor offers many [**configuration options**](/components/extractors/generic-extractor/configuration/). 

You may opt to use the [**visual builder**](/components/extractors/generic-extractor/configuration/#user-interface), which provides a very convenient way 
...
![Generic Extractor - UI](/components/extractors/generic-extractor/ui.png)
...
- Become familiar with [JSON format](/components/extractors/generic-extractor/tutorial/json/).
