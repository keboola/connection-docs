...
[Page Number Scroller](/components/extractors/generic-extractor/configuration/api/pagination/pagenum/).
...
Note that the **emptiness** is evaluated on the extracted array as [auto-detected](/components/extractors/generic-extractor/configuration/config/jobs/#data-field) or 
specified by the [`dataField`](/components/extractors/generic-extractor/configuration/config/jobs/#data-field) configuration. 
...
All [common stopping conditions](/components/extractors/generic-extractor/configuration/api/pagination/#stopping-strategy) apply as well.
