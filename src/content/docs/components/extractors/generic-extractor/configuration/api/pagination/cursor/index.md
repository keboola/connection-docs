...
This is expected behavior. [Common stopping conditions](/components/extractors/generic-extractor/configuration/api/pagination/#stopping-strategy) also apply.
