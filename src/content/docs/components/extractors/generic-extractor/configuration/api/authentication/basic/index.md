...
![Basic](/components/extractors/generic-extractor/configuration/api/authentication/basic.png)
...
They are also prefixed by the hash `#` character, which means they are stored [encrypted](/extend/encryption/). 
