...
![Google API Console](/components/extractors/generic-extractor/configuration/api/authentication/oauth20-login-console.png)
...
![Google OAuth 2.0 Playground 1](/components/extractors/generic-extractor/configuration/api/authentication/oauth20-login-playground-1.png)
...
![Google OAuth 2.0 Playground 1](/components/extractors/generic-extractor/configuration/api/authentication/oauth20-login-playground-2.png)

Then exchange the authorization code for tokens:

![Google OAuth 2.0 Playground 1](/components/extractors/generic-extractor/configuration/api/authentication/oauth20-login-playground-3.png)
