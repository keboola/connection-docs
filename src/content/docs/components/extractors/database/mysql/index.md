...
the [developer documentation](/components/extractors/database/). While setting up an SSH tunnel requires some work, it is the most reliable and secure
