...
description: "To combine multiple keywords enclose the query in brackets, e.g. the following matchess all unseen emails received from address sender-email@example.com with…"
