...
- [Google Drive](/components/extractors/storage/google-drive/) — imports data from Google Sheets (also part of the [Tutorial](/components/extractors/storage/google-sheets/)).
