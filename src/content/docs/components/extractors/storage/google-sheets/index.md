...
in your project's Storage. Unlike the [HTTP connector](/components/extractors/storage/http/), which
downloads from a public URL, this one reads spreadsheets you own — so it needs an authorized Google
account. For the *Google Drive* connector, which picks files out of Drive itself, see
[Google Drive](/components/extractors/storage/google-drive/).
...
![Google Spreadsheets Screenshot](/components/extractors/storage/google-sheets/google-sheets-spreadsheet.png)

## Configuration
1. Navigate to **Components** section in Keboola and click the **Add Component** button:

![Data Source Overview Screenshot](/components/extractors/storage/google-sheets/source-intro-0.png)

2. Utilize the search box to locate the *Google Sheets data source connector*. Once found, click on it.

![Data Source Overview Screenshot](/components/extractors/storage/google-sheets/source-intro.png)
...
![Create Google Sheets Configuration](/components/extractors/storage/google-sheets/google-sheets-create.png)
...
![Sign in with Google](/components/extractors/storage/google-sheets/sign-in-with-google.png)
  
6. On the following screen, click **Allow**.

![Access Google Account](/components/extractors/storage/google-sheets/allow.png)

7. Now you want to select the Google Drive files to import.

![Select Google Drive Files](/components/extractors/storage/google-sheets/select-files.png)
...
![Get Access to Spreadsheets](/components/extractors/storage/google-sheets/access-to-spreadsheets.png)

9. Use the search box to find your **Level** spreadsheet. Select it and click the **Select** button.

![Find Spreadsheet](/components/extractors/storage/google-sheets/find-spreadsheet.png)
...
![Save and Run Configuration](/components/extractors/storage/google-sheets/save-and-run.png)
...
![Go to Storage](/components/extractors/storage/google-sheets/storage.png)

## Going further

- [Google Drive](/components/extractors/storage/google-drive/) — the same idea, but picking files
  out of Drive rather than naming a spreadsheet.
