...
description: 'Data destination connectors that do not fit the database, storage, or BI categories — the long tail of delivery targets.'
...
- [Generic Writer](/components/writers/generic-writer/) — Sends any type of HTTP request, with or without data, to an
  arbitrary HTTP endpoint. Use it when no dedicated data destination connector exists for your target system.
