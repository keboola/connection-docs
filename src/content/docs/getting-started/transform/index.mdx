...
**Two ways to do it** — pick a tab in *Set it up* below. Doing it yourself, you run it
afterwards in the section below the tabs; doing it with Kai, the run is part of the prompt —
there you only check the result.
