...
(PRDCT-487 arc rework); screenshots pend the re-walk. Step 1 verified live in project 264 on 2026-08-04: searching
...
8. Select `out.c-octopus-atlas.octopus_atlas` and click **Next**.
...
10. On **Options**, name the *sheet* — the tab inside that file — `octopus_atlas`, select
