...
Whoever asked how deep octopuses really go will look in a spreadsheet, not in Keboola. This step
delivers the 10,000-row atlas to a Google Sheet — the same mechanism that later sends data to a
...
{/* Tutorial-type page (step 4 of 7). 2026-08-25: dataset swapped to the octopus atlas
...
- The table `octopus_atlas` in Storage, from
