...
**Check:** **4,838 meters** — *Grimpoteuthis challengeri*, a dumbo octopus, squarely in the
**abyssal zone**. That is the kind of thing nobody sees in four CSV files, and it took one
