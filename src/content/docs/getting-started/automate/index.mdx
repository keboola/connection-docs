...
If you skipped [the spreadsheet](/getting-started/write/), drop the third one and ask for two phases.
...
5. Repeat for a third phase holding the Google Sheets destination configuration. If you skipped
   [the spreadsheet](/getting-started/write/), stop at two phases.
