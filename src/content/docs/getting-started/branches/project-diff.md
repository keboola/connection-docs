...
You have already learned how [files](/getting-started/branches/files-in-branch/) and [tables](/getting-started/branches/tables-in-branch/) 
...
![Screenshot - Project Diff](/getting-started/branches/figures/show-project-diff.png)
...
![Screenshot - Project Diff](/getting-started/branches/figures/project-diff.png)

You should see a highlighted configuration diff. 

![Detailed diff of configuration change](/getting-started/branches/figures/diff-config-show-changed.png)
...
![Detailed diff of configuration change](/getting-started/branches/figures/diff-config-show-all.png)
...
[created in branch](/getting-started/branches/tables-in-branch/#extend-the-transformation) will not be transferred to production, 
...
Continue to the last part of our tutorial where we will show you how to [merge the branch back to production](/getting-started/branches/merge-to-production/).