...
If you need to setup your Keboola CLI, simply follow the instructions displayed on this page. For more detailed information go to the [keboola-as-code repository](https://github.com/keboola/keboola-as-code).
