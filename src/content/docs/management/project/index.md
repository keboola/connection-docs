...
If you need to setup your Keboola CLI, simply follow the instructions displayed on this page. The CLI itself lives at [keboola/keboola-as-code](https://github.com/keboola/keboola-as-code); its install commands are on the [dbt CLI page](/transformations/dbt/cli/).
