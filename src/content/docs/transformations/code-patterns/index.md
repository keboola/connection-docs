...
<!-- TODO(human-review: transcribe generated-code screenshot) This screenshot
     shows generated code — per the "code/config never as an image" rule it
     should be a fenced code block. The content is code-pattern-specific and
     wasn't viewable here, so add a representative fenced example. -->
