...
![TODO(human-review: alt unverified) Overview of the dbt transformation configuration screen](imgs/dbt-transformation-overview.webp)
...
![TODO(human-review: alt unverified) The Database Connection section for a dbt transformation with a remote warehouse](imgs/dbt-transformation-db-connection.webp)

### dbt Project Repository

First, you must define a repository by specifying the URL (ending with GIT) and entering the access credentials if required.

![TODO(human-review: alt unverified) The dbt Project Repository section with fields for the GIT URL and access credentials](imgs/2776563898.png)

After saving a configuration, click **Load Branches** to select the desired branch. Don't forget to click **Save**.

![TODO(human-review: alt unverified) The Load Branches control for selecting a repository branch](imgs/2776563904.png)

### Execution Steps

![TODO(human-review: alt unverified) The Execution Steps section listing the dbt steps to run](imgs/2740748169.png)
...
![TODO(human-review: alt unverified) Editing an execution step to append dbt flags or resource selectors](imgs/dbt-transformation-step-edit.webp)
...
![TODO(human-review: alt unverified) The Freshness settings with independent warning and error time limits](imgs/2740735193.png)
...
![TODO(human-review: alt unverified) The Output Mapping section defining which tables are imported to Storage](imgs/2776563928.png)
...
![TODO(human-review: alt unverified) The right-hand run panel with dbt Core version, backend size, threads, debug, and documentation options](imgs/dbt-transformation-run.webp)
...
![TODO(human-review: alt unverified) The Discover tab timeline showing the build duration of each model](imgs/2777448784.png)
