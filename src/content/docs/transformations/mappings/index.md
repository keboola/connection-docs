...
*See an example of [setting up an input mapping](/getting-started/transform/#input-mapping) in our tutorial.*
...
*See an example of [setting up an output mapping](/getting-started/transform/#output-mapping) in our tutorial.*
