...
| `overview/api/index.md` | `/overview/api/` | Keboola Overview | `/overview/` | explanation+index | flag | REDIRECT — MERGED (2026-09-09, connection-docs#1120): portals, token header, service index and apis.json folded into /overview/#apis; catalogue and endpoint tables dropped (portal + GET /v2/storage are the source of truth) |
