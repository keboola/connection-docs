...
| `overview/api/index.md` | `/overview/api/` | Keboola Overview | `/overview/apis/` | explanation+index | flag | MOVED (2026-09-14, connection-docs#1120): the page became /overview/apis/ so the redirect lands exactly (Jordan's review); catalogue and endpoint tables dropped (portal + GET /v2/storage are the source of truth) |
