---
title: Design
permalink: /flows/orchestrator/design/
redirect_from:
    - /orchestrator/design/
---

Setting [tasks](/flows/orchestrator/tasks/) for an orchestration, or creating [nested orchestrations](/flows/orchestrator/tasks/nesting/)
...
## Pipelines
The approach we showed in the [introduction](/flows/orchestrator/tasks/) can be described as data pipelines and characterized as
...
{: .image-popup}
![Configuration Dependencies](/flows/orchestrator/design/dependencies-1.png)
...
{: .image-popup}
![Complex Configuration Dependencies](/flows/orchestrator/design/dependencies-2.png)
...
transformations, or you can use [nested orchestrations](/flows/orchestrator/tasks/nesting/) to handle these. The schedule of the 
...
{: .image-popup}
![Complex Configuration Dependencies + Pipeline](/flows/orchestrator/design/dependencies-3.png)
...
{: .image-popup}
![Mirroring Orchestrations](/flows/orchestrator/design/dependencies-4.png)
