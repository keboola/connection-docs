---
title: Nesting
permalink: /flows/orchestrator/tasks/nesting/
redirect_from:
...
In the [basic configuration description](/flows/orchestrator/tasks/), we used an example orchestration
...
{: .image-popup}
![Task Dependencies](/flows/orchestrator/tasks/nesting/dependencies-1.png)
...
{: .image-popup}
![Screenshot - Orchestration Get Campaign Performance](/flows/orchestrator/tasks/nesting/tasks-1.png)

and a second orchestration named `Update Campaign Recipient list` with tasks `Campaign Recipients` and `New recipients`:

{: .image-popup}
![Screenshot - Orchestration Update Campaign Recipient list](/flows/orchestrator/tasks/nesting/tasks-2.png)
...
{: .image-popup}
![Screenshot - Orchestration Update Campaign Recipient list](/flows/orchestrator/tasks/nesting/tasks-3.png)

The execution of tasks can be visualized using the following sequence diagram:

{: .image-popup}
![Screenshot - Orchestration Update Campaign Recipient list](/flows/orchestrator/tasks/nesting/orchestration-sequence-1.png)
