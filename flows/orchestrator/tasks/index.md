---
title: Tasks
permalink: /flows/orchestrator/tasks/
redirect_from:
    - /orchestrator/tasks/
---
...
{: .image-popup}
![Screenshot - Orchestration Create](/flows/orchestrator/tasks/configuration-create.png)

## Add Tasks
The first step is to add orchestration **tasks** --- the component configurations you wish to run --- by clicking on **Configure Tasks**:

{: .image-popup}
![Screenshot - Orchestration Main Page](/flows/orchestrator/tasks/orchestration-main-1.png)

Continue with **New Task**:

{: .image-popup}
![Screenshot - Orchestration Tasks](/flows/orchestrator/tasks/tasks-1.png)

A list of configured components is shown:

{: .image-popup}
![Screenshot - Orchestration Tasks](/flows/orchestrator/tasks/tasks-list-1.png)
...
{: .image-popup}
![Screenshot - Orchestration Tasks Configurations](/flows/orchestrator/tasks/tasks-list-2.png)
...
{: .image-popup}
![Screenshot - Orchestration Tasks Added](/flows/orchestrator/tasks/tasks-2.png)
...
[Job execution](/flows/orchestrator/running/#orchestration-execution).

When this rule is applied to the above task configuration, it leads to the following sequence of execution:

{: .image-popup}
![Orchestration Tasks Sequence](/flows/orchestrator/tasks/orchestration-sequence-1.png)
...
{: .image-popup}
![Screenshot - Orchestration Tasks Order](/flows/orchestrator/tasks/tasks-3.png)

The tasks are now reordered:

{: .image-popup}
![Screenshot - Orchestration Tasks Ordered](/flows/orchestrator/tasks/tasks-4.png)

The above will lead to the following execution sequence:

{: .image-popup}
![Orchestration Tasks Sequence Organized](/flows/orchestrator/tasks/orchestration-sequence-2.png)
...
{: .image-popup}
![Screenshot - Move Task](/flows/orchestrator/tasks/tasks-5.png)

Type `Second Transformation Phase` to create a new orchestration phase:

{: .image-popup}
![Screenshot - Add Phase](/flows/orchestrator/tasks/phase-name.png)
...
{: .image-popup}
![Screenshot - Move Phase](/flows/orchestrator/tasks/tasks-6.png)

The result should be this:

{: .image-popup}
![Screenshot - Phase Moved](/flows/orchestrator/tasks/tasks-7.png)

Which corresponds to the following execution sequence:

{: .image-popup}
![Orchestration Tasks Sequence Serialized](/flows/orchestrator/tasks/orchestration-sequence-3.png)
...
Another way of handling dependencies is using [nested orchestrations](/flows/orchestrator/tasks/nesting/).
