---
title: Running
permalink: /flows/orchestrator/running/
redirect_from:
...
{: .image-popup}
![Screenshot - Orchestration Main Page Configured](/flows/orchestrator/running/orchestration-main-1.png)
...
{: .image-popup}
![Screenshot - Run Orchestration](/flows/orchestrator/running/orchestration-run.png)

Each execution of the orchestration is shown in the Last Runs section of the orchestration:

{: .image-popup}
![Screenshot - Orchestration Jobs](/flows/orchestrator/running/orchestration-main-2.png)

Clicking on the job row takes you to the orchestration job details:

{: .image-popup}
![Screenshot - Orchestration Jobs](/flows/orchestrator/running/orchestration-jobs.png)
...
{: .image-popup}
![Screenshot - Orchestration Jobs](/flows/orchestrator/running/job-retry.png)
...
{: .image-popup}
![Screenshot - Orchestration Schedule](/flows/orchestrator/running/orchestration-main-3.png)
...
{: .image-popup}
![Screenshot - Orchestration Schedule](/flows/orchestrator/running/schedule.png)
...
{: .image-popup}
![Screenshot - Event Trigger](/flows/orchestrator/running/schedule-custom.png)
...
{: .image-popup}
![Screenshot - Event Trigger](/flows/orchestrator/running/time-zone.png)

Before scheduling an orchestration, be sure to run it first to see what schedule would work best. An orchestration 
itself is considered a component configuration and it will [not run in parallel](/flows/orchestrator/running/#parallel-jobs). 
...
{: .image-popup}
![Screenshot - Event Trigger](/flows/orchestrator/running/event-trigger.png)
...
is going to be updated (unlike with **[Time Schedule](/flows/orchestrator/running/#1-time-schedule)**). You can just wait 
...
{: .image-popup}
![Screenshot - Orchestration Token](/flows/orchestrator/running/orchestration-main-4.png)

All the jobs created by the orchestration (data source and destination connectors, etc.) are run using the orchestration token.
...
{: .image-popup}
![Screenshot - Orchestration Token](/flows/orchestrator/running/token-permissions.png)
...
The above can be added to the [basic rule of orchestrations](/flows/orchestrator/tasks/#organize-tasks):
