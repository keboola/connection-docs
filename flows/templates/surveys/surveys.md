---
title: Surveys
permalink: /flows/templates/surveys/
redirect_from:
    - /templates/surveys/
---
...
{: .image-popup}
![Business Data Model](/flows/templates/surveys/business-data-model.png)
...
{: .image-popup}
![Add New Template](/flows/templates/surveys/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add Typeform to Snowflake](/flows/templates/surveys/add-typeform-to-snowflake.png)
...
{: .image-popup}
![Typeform to Snowflake - Template Name](/flows/templates/surveys/typeform-to-snowflake-name.png)
...
authorization problems. If you are struggling with this part, go to the section [Authorizing Data Destinations](/flows/templates/surveys/#authorizing-data-destinations) below.
...
{: .image-popup}
![Typeform to Snowflake](/flows/templates/surveys/typeform-to-snowflake-steps.png)
...
{: .image-popup}
![Typeform to Google Sheets - Flows](/flows/templates/surveys/typeform-to-snowflake-flow.png)
...
{: .image-popup}
![Typeform Data Source](/flows/templates/surveys/typeform-data-source.png)
