...
permalink: /flows/templates/ua-and-ga4-comparison/
redirect_from:
    - /templates/ua-and-ga4-comparison/
---
...
{: .image-popup}
![Name Template](/flows/templates/ua-and-ga4-comparison/name-template.png)

Then you will configure the template:

{: .image-popup}
![Flow 2](/flows/templates/ua-and-ga4-comparison/required-configurations2.png)
...
{: .image-popup}
![Authorize Data Source](/flows/templates/ua-and-ga4-comparison/universal-analytics.png)

### Google Analytics 4
Please authorize your Google Analytics 4 account.

{: .image-popup}
![Authorize Data Source GA4](/flows/templates/ua-and-ga4-comparison/ga4.png)
...
{: .image-popup}
![Error Message](/flows/templates/ua-and-ga4-comparison/job-error.png)
