---
title: Repository
permalink: /flows/templates/repository/
redirect_from:
...
{: .image-popup}
![Business Data Model](/flows/templates/repository/business-data-model.png)
...
{: .image-popup}
![Add New Template](/flows/templates/repository/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add GitHub to Snowflake](/flows/templates/repository/add-github-to-snowflake.png)
...
{: .image-popup}
![GitHub to Snowflake - Template Name](/flows/templates/repository/github-to-snowflake-name.png)
...
authorization problems. If you are struggling with this part, go to the section [Authorizing Data Destinations](/flows/templates/repository/#authorizing-data-destinations) below.
...
{: .image-popup}
![GitHub to Snowflake](/flows/templates/repository/github-to-snowflake-steps.png)
...
{: .image-popup}
![GitHub to Google Sheets - Flows](/flows/templates/repository/github-to-snowflake-flow.png)
...
{: .image-popup}
![GitHub Data Source](/flows/templates/repository/github-data-source.png)
