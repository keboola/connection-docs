...
permalink: /flows/templates/customer-relationship-management/
redirect_from:
    - /templates/customer-relationship-management/
---
...
{: .image-popup}
![Business Data Model](/flows/templates/customer-relationship-management/business-data-model.png)
...
{: .image-popup}
![Add New Template](/flows/templates/customer-relationship-management/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add CRM to Snowflake](/flows/templates/customer-relationship-management/add-crm-to-snowflake.png)
...
{: .image-popup}
![CRM to Snowflake - Template Name](/flows/templates/customer-relationship-management/crm-to-snowflake-name.png)
...
authorization problems. If you are struggling with this part, go to the section [Authorizing Data Destinations](/flows/templates/customer-relationship-management/#authorizing-data-destinations) below.
...
{: .image-popup}
![CRM to Snowflake](/flows/templates/customer-relationship-management/crm-to-snowflake-steps.png)
...
{: .image-popup}
![CRM to Google Sheets - Flows](/flows/templates/customer-relationship-management/crm-to-snowflake-flow.png)
...
{: .image-popup}
![Salesforce Data Source](/flows/templates/customer-relationship-management/salesforce-data-source.png)
 
### Pipedrive
Fill in your company domain and the API token. You can find it in Settings > Personal preferences > API.

{: .image-popup}
![Pipedrive Data Source](/flows/templates/customer-relationship-management/pipedrive-data-source.png)
