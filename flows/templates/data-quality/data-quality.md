---
title: Data Quality
permalink: /flows/templates/data-quality/
redirect_from:
    - /templates/data-quality/
---
...
## Tests
{: .image-popup}
![Data Quality Shared Codes](/flows/templates/data-quality/shared_code_1.png)
...
{: .image-popup}
![Add New Template](/flows/templates/data-quality/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add Data Quality to Snowflake](/flows/templates/data-quality/add-dq-to-snowflake.png)
...
{: .image-popup}
![Data Quality to Snowflake - Template Name](/flows/templates/data-quality/dq-to-snowflake-name.png)

After clicking **Next Step**, you will see the template builder. You do not need to edit any configuration.

{: .image-popup}
![Data Quality to Snowflake](/flows/templates/data-quality/dq-to-snowflake-steps.png)
...
{: .image-popup}
![Data Quality to Google Sheets - Flows](/flows/templates/data-quality/dq-to-snowflake-flow.png)
...
{: .image-popup}
![Data Quality Core Full Example](/flows/templates/data-quality/dq-core-full-example.png)
...
{: .image-popup}
![Data Quality Core Full Example](/flows/templates/data-quality/dq-core-abort-example.png)
