...
permalink: /flows/templates/marketing-platforms/
redirect_from:
...
{: .image-popup}
![Flow](/flows/templates/marketing-platforms/adsplatforms-flow.png)
...
{: .image-popup}
![Ads Platforms - Add New Template](/flows/templates/marketing-platforms/adsplatforms-add-new-template.png)

This page contains information about the template. Click **+ Set Up Template** again.

{: .image-popup}
![Ads Platforms - Set Up Template](/flows/templates/marketing-platforms/adsplatforms-set-up-template.png)
...
{: .image-popup}
![Ads Platforms - Template Name](/flows/templates/marketing-platforms/adsplatforms-template-name.png)
...
{: .image-popup}
![Ads Platforms - Flow](/flows/templates/marketing-platforms/adsplatforms-flow.png)
...
{: .image-popup}
![Facebook Ads Data Source](/flows/templates/marketing-platforms/facebook-ads-data-source.png)
...
{: .image-popup}
![Bing Ads Data Source](/flows/templates/marketing-platforms/bing-ads-data-source.png)
...
{: .image-popup}
![LinkedIn Ads Data Source](/flows/templates/marketing-platforms/linkedin-ads-data-source.png)
...
{: .image-popup}
![Google Ads Data Source](/flows/templates/marketing-platforms/google-ads-data-source.png)
...
{: .image-popup}
![PostgreSQL Destination](/flows/templates/marketing-platforms/postgresql-data-destination.png)
