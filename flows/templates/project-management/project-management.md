...
permalink: /flows/templates/project-management/
redirect_from:
...
{: .image-popup}
![Business Data Model](/flows/templates/project-management/business-data-model.png)
...
{: .image-popup}
![Add New Template](/flows/templates/project-management/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add PM to Snowflake](/flows/templates/project-management/add-pm-to-snowflake.png)
...
{: .image-popup}
![PM to Snowflake - Template Name](/flows/templates/project-management/pm-to-snowflake-name.png)
...
authorization problems. If you are struggling with this part, go to the section [Authorizing Data Destinations](/flows/templates/project-management/#authorizing-data-destinations) below.
...
{: .image-popup}
![PM to Snowflake](/flows/templates/project-management/pm-to-snowflake-steps.png)
...
{: .image-popup}
![PM to Google Sheets - Flows](/flows/templates/project-management/pm-to-snowflake-flow.png)
...
{: .image-popup}
![Asana Data Source](/flows/templates/project-management/asana-data-source.png)
...
{: .image-popup}
![Jira Data Source](/flows/templates/project-management/jira-data-source.png)
...
{: .image-popup}
![PostgreSQL Data Destination](/flows/templates/project-management/postgresql-data-destination.png)
