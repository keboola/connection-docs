...
permalink: /flows/templates/social-media-engagement/
redirect_from:
    - /templates/social-media-engagement/
---
...
{: .image-popup}
![Output Tables](/flows/templates/social-media-engagement/output-table-1.png)
...
{: .image-popup}
![Add New Template](/flows/templates/social-media-engagement/add-new-template.png)

This page contains information about the template. Click **+ Use Template** again.

{: .image-popup}
![Add Social Media Engagement](/flows/templates/social-media-engagement/add-socmed-eng.png)
...
{: .image-popup}
![Add Social Media Engagement - Template Name](/flows/templates/social-media-engagement/socmed-eng-name.png)
...
If you are struggling with this part, go to the section [Authorizing Data Destinations](/flows/templates/social-media-engagement/#authorizing-data-destinations) below.
...
{: .image-popup}
![Social Media Engagement - Steps](/flows/templates/social-media-engagement/socmed-eng-steps.png)
...
{: .image-popup}
![Social Media Engagement - Flows](/flows/templates/social-media-engagement/socmed-eng-flow.png)
...
{: .image-popup}
![Facebook Pages Data Source](/flows/templates/social-media-engagement/facebook-pages-data-source.png)
...
{: .image-popup}
![Instagram Page Data Source](/flows/templates/social-media-engagement/instagram-pages-data-source.png)
...
{: .image-popup}
![LinkedIn Pages Data Source](/flows/templates/social-media-engagement/linkedin-pages-data-source.png)

### Twitter Page
To access your data from Twitter, authorize the account and fill in the user name.

{: .image-popup}
![Twitter Page Data Source](/flows/templates/social-media-engagement/twitter-pages-data-source.png)

### YouTube Channel
To access data from your YouTube Channel, authorize access via Open Authentication and save the configuration.

{: .image-popup}
![YouTube Channel Data Source](/flows/templates/social-media-engagement/youtube-channel-data-source.png)
...
{: .image-popup}
![MySQL Destination](/flows/templates/social-media-engagement/mysql-destination.png)
...
{: .image-popup}
![PostgreSQL Destination](/flows/templates/social-media-engagement/postgresql-data-destination.png)
