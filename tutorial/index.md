...
using the [Snowflake Database](https://www.snowflake.net/) extractor (the procedure is the same for [all our database extractors](/components/extractors/database/)).
