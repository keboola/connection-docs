...
_**Note:** When table is created from base types it uses default lengths and precisions of the target backend. For example in Snowflake this means, that NUMBER base type is created as NUMBER(38,0), which might be unexpected if the source database column is NUMBER(10,2)._  
