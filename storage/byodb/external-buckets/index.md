...
### Snowflake
Fill in the **name** of the new bucket, **database** name, and **schema** name. Click **Next Step**. Keboola will then generate a code for you that you can use to 
...
### BigQuery
Fill in the **name** of the new dataset and **dataset** name. Click **Next Step**. Keboola will generate a code for you that you can use to correctly grant Keboola 
